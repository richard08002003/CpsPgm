           ...
           **send()  寫資料*/
            while(1) {
                while(1) {
                    ...
                    fp4 = fopen( "/home/richard/Richard/air_main/20150114/TestLog/Cps_SendLog.txt" , "w" ) ;
            ...
            ** recv() 讀取資料*/
                while(1) {
                    //初始化str[ ]
                    unsigned char str[200] = {0} ;
                    fp5 = fopen( "/home/richard/Richard/air_main/20150114/TestLog/Cps_ReceiveLog.txt" , "w" ) ;
                    if ( fp5 == NULL) {
                        printf("Cps_ReceiveLog.txt 檔案開啟錯誤 ! ") ;
                        break ;
                    }
                    ...
                    if( val < 0 ) {
                        ...
                        printf("\n接收 MainGateway Client's 的資料為：%s \n", str ) ;
                        fprintf( fp5 , "%s" , "\n接收 MainGateway Client's 的資料為：" ) ;
                        fprintf( fp5 , "%s\n" , str ) ;
